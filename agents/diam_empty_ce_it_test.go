...
func testDiamEmptyCEItConnectDiameterClient(t *testing.T) {
	diamClntND, err = NewDiameterClient(daCfgND.DiameterAgentCfg().Listeners[0].Listen,
		"INTEGRATION_TESTS",
		...
		daCfgND.DiameterAgentCfg().DictionariesPath, daCfgND.DiameterAgentCfg().Listeners[0].ListenNet)
