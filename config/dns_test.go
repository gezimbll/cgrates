...
func TestDNSAgentCfgloadFromJsonCfg(t *testing.T) {
	...
	expected := &DNSAgentCfg{
		...
		Conns: map[string][]*DynamicStringSliceOpt{
			utils.MetaSessionS: {
				{Values: []string{utils.ConcatenatedKey(rpcclient.BiRPCInternal, utils.MetaSessionS)}},
...
func TestDNSAgentCfgAsMapInterface(t *testing.T) {
	...
	eMap := map[string]any{
		...
		utils.ConnsCfg: map[string][]*DynamicStringSliceOpt{
			utils.MetaSessionS:   {{Values: []string{rpcclient.BiRPCInternal}}, {Values: []string{utils.MetaInternal}}},
...
func TestDNSAgentCfgAsMapInterface1(t *testing.T) {
	...
	eMap := map[string]any{
		...
		utils.ConnsCfg: map[string][]*DynamicStringSliceOpt{
			utils.MetaSessionS:   {{Values: []string{rpcclient.BiRPCInternal}}, {Values: []string{utils.MetaInternal, "*conn1"}}},
