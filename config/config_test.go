...
func TestV1GetConfigAsJSONSessionS(t *testing.T) {
	var reply string
	expected := `{"sessions":{"alterableFields":[],"channelSyncInterval":"0","clientProtocol":1,"conns":{},"defaultUsage":{"*any":"3h0m0s","*data":"1048576","*sms":"1","*voice":"3h0m0s"},"enabled":false,"listenBiGob":"","listenBiJSON":"127.0.0.1:2014","minDurLowBalance":"0","opts":{"*accounts":[{"filterIDs":null,"tenant":""}],"*accountsDebit":[],"*accountsForceUsage":[],"*attributes":[{"filterIDs":null,"tenant":""}],"*attributesDerivedReply":[{"filterIDs":null,"tenant":""}],"*autoChargeInterval":[{"filterIDs":null,"tenant":""}],"*blockerError":[{"filterIDs":null,"tenant":""}],"*cdrs":[{"filterIDs":null,"tenant":""}],"*cdrsDerivedReply":[{"filterIDs":null,"tenant":""}],"*chargeable":[{"filterIDs":null,"tenant":""}],"*chargers":[{"filterIDs":null,"tenant":""}],"*debit":[],"*ees":[],"*eesIDs":[],"*forceUsage":[],"*initiate":[{"filterIDs":null,"tenant":""}],"*ips":[{"filterIDs":null,"tenant":""}],"*ipsAllocate":[{"filterIDs":null,"tenant":""}],"*ipsAuthorize":[{"filterIDs":null,"tenant":""}],"*ipsRelease":[{"filterIDs":null,"tenant":""}],"*maxUsage":[{"filterIDs":null,"tenant":""}],"*message":[{"filterIDs":null,"tenant":""}],"*originID":[],"*rates":[{"filterIDs":null,"tenant":""}],"*refund":[],"*resources":[{"filterIDs":null,"tenant":""}],"*resourcesAllocate":[{"filterIDs":null,"tenant":""}],"*resourcesAuthorize":[{"filterIDs":null,"tenant":""}],"*resourcesDerivedReply":[{"filterIDs":null,"tenant":""}],"*resourcesRelease":[{"filterIDs":null,"tenant":""}],"*routes":[{"filterIDs":null,"tenant":""}],"*routesDerivedReply":[{"filterIDs":null,"tenant":""}],"*stats":[{"filterIDs":null,"tenant":""}],"*statsDerivedReply":[{"filterIDs":null,"tenant":""}],"*terminate":[{"filterIDs":null,"tenant":""}],"*thresholds":[{"filterIDs":null,"tenant":""}],"*thresholdsDerivedReply":[{"filterIDs":null,"tenant":""}],"*ttl":[{"filterIDs":null,"tenant":""}],"*ttlLastUsage":[],"*ttlLastUsed":[],"*ttlMaxDelay":[{"filterIDs":null,"tenant":""}],"*ttlUsage":[],"*update":[{"filterIDs":null,"tenant":""}],"*ur":[]},"sessionIndexes":[],"stir":{"allowedAttest":["*any"],"defaultAttest":"A","payloadMaxduration":"-1","privateKeyPath":"","publicKeyPath":""},"storeSessionCosts":false,"terminateAttempts":5}}`
	cfgCgr := NewDefaultCGRConfig()
...
func TestV1GetConfigAsJSONFKamailioAgent(t *testing.T) {
	var reply string
	expected := `{"kamailioAgent":{"conns":{"*sessions":[{"filterIDs":null,"tenant":"","connIDs":["*birpc_internal"]}]},"createCDR":false,"enabled":false,"evapiConns":[{"address":"127.0.0.1:8448","alias":"","maxReconnectInterval":"0s","reconnects":5}],"requestProcessors":[],"timezone":""}}`
	cfgCgr := NewDefaultCGRConfig()
