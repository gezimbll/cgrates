...
func tagConnsOpt(conns map[string][]*DynamicStringSliceOpt) map[string][]*DynamicStringSliceOpt {
	if conns == nil {
		return nil
	}
...
func stripConnsOpt(conns map[string][]*DynamicStringSliceOpt) map[string][]*DynamicStringSliceOpt {
	if conns == nil {
		return nil
	}
	result := make(map[string][]*DynamicStringSliceOpt, len(conns))
