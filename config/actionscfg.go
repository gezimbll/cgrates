...
func (actOpts *ActionsOpts) loadFromJSONCfg(jsnCfg *ActionsOptsJson) (err error) {
	...
	if jsnCfg.ProfileIgnoreFilters != nil {
		...
		populateDynOpts(&actOpts.ProfileIgnoreFilters, prfIgnFltr)
	}
	actOpts.ProfileIgnoreFilters = append(actOpts.ProfileIgnoreFilters, &DynamicBoolOpt{nil, "", ActionsProfileIgnoreFiltersDftOpt, nil})
