...
"freeswitch_agent": {
	...
	eMap := map[string]any{
		utils.EnabledCfg:                true,
		utils.ConnsCfg:                  map[string][]*DynamicStringSliceOpt{utils.MetaSessionS: {{Values: []string{rpcclient.BiRPCInternal, "*conn1", "*conn2"}}}},
...
func TestFsAgentCfgAsMapInterfaceCase3(t *testing.T) {
	...
	eMap := map[string]any{
		utils.EnabledCfg:                false,
		utils.ConnsCfg:                  map[string][]*DynamicStringSliceOpt{utils.MetaSessionS: {{Values: []string{utils.MetaInternal}}}},
		utils.SubscribeParkCfg:          true,
		utils.CreateCdrCfg:              false,
