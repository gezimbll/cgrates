...
// CloneConnsOpt deep-copies a connections opts map.
...
// ConnsOptEqual checks equality of two connections opts maps.
func ConnsOptEqual(v1, v2 map[string][]*DynamicStringSliceOpt) bool {
	if len(v1) != len(v2) {
		return false
	}
